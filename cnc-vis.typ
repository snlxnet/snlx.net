...
#slide[
  ...
  #linebreak()
  #text(size: 20pt)[
    Эксперементальный проект студента гр. 24-МБ-АП1\
    Гуденко Александра Сергеевича
  ]
...
#slide[
  ...
  ```js
  прыг(x, y)                   //   G0   быстрое перемещение
  режь(x, y)                   //   G1   линия
  кружись(радиус, x, y)        //   G2   по часовой
  кружисьОбратно(радиус, x, y) //   G3   против часовой
  нуль()                       //        в нуль инструмента
  ```
]
#notes[
...
#slide[
  ...
  #link("https://snlx.net/cnc-vis")[Запуск]
]
