...
Это достаточно простой проект ([посмотрите на него](/cert)), поэтому он даёт возможность заодно поработать и над этим сайтом, т.к. стили будут общими. На сайте я не хочу держать растровые изображения, поэтому постараюсь использовать исключительно SVG.
